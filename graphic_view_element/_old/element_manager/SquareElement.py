...
from graphic_view_element._old.resizable_element.SquareResize import ResizableSquareItem
...
class SquareElement(GraphicElementBase):
    def create_graphics_item(self):
        ...
        item = ResizableSquareItem(rect) # QGraphicsRectItem(rect)
        item.setPen(pen)
        item.setBrush(brush)
